...
export default function TawsilexIntegration({ integration, onUpdate }) {
            ...
            <div className="bg-gradient-to-r from-orange-600 to-orange-700 px-6 py-4">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-white">Tawsilex</h2>
                            <p className="text-orange-100 text-sm">Moroccan Delivery Service</p>
                        </div>
                    </div>
                ...
                {!integration || isEditing ? (
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex items-center">
                            ...
                            />
                            <label htmlFor="tawsilex-active" className="ml-2 text-sm text-gray-700">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            ...
                            <ul className="text-sm text-blue-800 space-y-1">
                                ...
                                <li>• Get available statuses</li>
                                <li>• Support for exchanges and package opening</li>
                            </ul>
                        </div>
                        ...
                        <div className="flex space-x-3 pt-4">
                            ...
                            >
                                {integration ? 'Update Integration' : 'Connect Tawsilex'}
                            </button>
                            {integration && (
                                <button
                                    type="button"
